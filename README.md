...
- 구조·흐름: [docs/개발/아키텍처.md](docs/개발/아키텍처.md)
- 결정 이력(ADR): [docs/개발/의사결정/](docs/개발/의사결정/) — GAS 정시 발송 · 하루1회 게이트 · 개장할인율 추정
- 팀 운영: [CLAUDE.md](CLAUDE.md) · 진행 이력: [docs/작업로그/작업로그.html](docs/작업로그/작업로그.html)
</content>
</invoke>
